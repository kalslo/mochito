...
import {
  List, ListItem, ListItemText, IconButton, Checkbox, Typography, Box, CircularProgress, Paper, Chip, ButtonGroup, Button
} from '@mui/material';
      ...
      <List sx={{ p: 0 }}>
        ...
        {tasks.map((task, index) => (
          ...
          >
            ...
            >
                <ButtonGroup size="small" aria-label="priority selector">
                  {['P1','P2','P3'].map(p => (
                    <Button
                      key={p}
